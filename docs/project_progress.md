...
- 下一步建议：进入 P8b-3-lite，在 Misc8 上跑 P4/P5/P6/P8a，但暂不进入 P7b two-swap；只有当 Misc8 出现多个 `llc + clang` both-smaller depth1 case，再考虑 bounded two-swap。
