...
- 下一步建议：P9-4c 中 `Depth1BothSmallerPrograms = 0`，不进入 two-swap、不做 attribution；下一步优先进入 P9-5 combined 24-program summary，把 Stanford-8、Misc8、Diverse8 的证书层、depth1 层和 objective-layer 结果汇总到同一张 MVP+ 总表。
